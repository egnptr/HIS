  ...
  <div class="row">
    ...
    <h2>Formulir Pendaftaran</h2><br>
      <form>
        ...
        <fieldset class="form-group">
          <div class="row">
            <label class="col-form-label col-sm-2 pt-0">Departemen</label>
            <div class="col-sm-10">
              <div class="form-check">
                <input class="form-check-input" type="radio" name="gridRadios" id="ronsen" value="option3" checked>
                <label class="form-check-label" for="ronsen">
                  Rontgen
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="gridRadios" id="mri" value="option4">
                <label class="form-check-label" for="mri">
                  MRI
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="gridRadios" id="ct" value="option5">
