...
@section('title')
<title>Outpatient - Patient Details</title>
@endsection
...
@section('content')
    <div class="flex justify-center">
        <div class="w-8/12">
            ...
            <div class="flex p-6">
                <a href="{{ route('outpatient.payment', $patient) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">Check Payment</a>
            </div>
            
            <div class="flex p-6">
                <a href="{{ route('pharmacy.prescribe') }}" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded">Prescribe Medicine</a>
            </div>
            
            <div class="flex p-6">
                <a href="{{ route('outpatient.patientlist') }}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded">Back to list</a>
            </div>
