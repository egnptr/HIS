...
<div id="ambil" class="container-fluid">
  <div class="row">
    <div class="col-sm-8">
    <h2>Pengambilan Hasil</h2><br>
    ...
    <form>
        ...
        <div class="form-group row">
          <label for="idPas" class="col-sm-2 col-form-label">ID Pasien</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="idPas" >
          </div>
        </div>
        
        <div class="form-group row">
          <div class="col-sm-10">
            <a button type="submit" class="btn btn-primary" href="/result">Submit</a>
          </div>
        </div>
