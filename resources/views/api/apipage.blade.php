        ...
        <div class="branding docs-branding">
            <div class="container-fluid position-relative py-2">
                <div class="docs-logo-wrapper">
	                ...
	                <div class="site-logo"><a class="navbar-brand" href="index.html"><img class="logo-icon mr-2" src="{{ url('/apicss/assets/images/coderdocs-logo.svg') }}" alt="logo"><span class="logo-text">Coder<span class="text-alt">Docs</span></span></a></div>    
    ...
    <span class="hljs-attr">"description"</span>: {<span class="hljs-attr">"text"</span>: <span class="hljs-string">"..."</span>, <span class="hljs-attr">"sensitive"</span>: <span class="hljs-literal">false</span>}
					...
					<section class="docs-section" id="item-1-2">
						...
						<figure class="figure docs-figure py-3">
						    <a href="{{ url('/apicss/assets/images/features/appify-theme-projects-overview-lg.jpg') }}" data-title="Image Lightbox Example" data-toggle="lightbox"><img class="figure-img img-fluid shadow rounded" src="{{ url('/apicss/assets/images/features/appify-add-members.gif') }}" alt="" style="width: 600px;"></a>
