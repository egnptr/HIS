...
@section('title')
<title>Radiology - Patient Details</title>
@endsection
    ...
    <div class="flex justify-center">
        <div class="w-8/12">
            ...
            <div class="flex p-6">
             ...
             <div class="flex p-6">
                <a href="{{ route('Radiologi.checkout', $patient) }}" class="bg-yellow-500 hover:bg-yellow-700 text-white font-bold py-2 px-4 rounded">Checkout</a>
            </div>
