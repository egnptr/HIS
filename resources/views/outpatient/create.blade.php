...
<div class="flex flex-col h-screen">
    <div class="grid place-items-center mx-2 my-20 sm:my-auto">
        ...
        bg-white rounded-lg shadow-md lg:shadow-lg">
            ...
            <form method="POST" action="{{ route('outpatient.create') }}">
                @csrf
                ...
                <input id="type" type="text" name="type" value="Outpatient" hidden/>
                <input id="status" type="text" name="status" value="Ongoing" hidden/>
                <input id="scanning_tool" type="text" name="scanning_tool" value="NULL" hidden/>

                <div class="flex items-center justify-end px-4 py-3 space-x-4 sm:px-6">
                    <a href="{{ route('outpatient.patientlist') }}" class="inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:shadow-outline-gray disabled:opacity-25 transition ease-in-out duration-150">
                        Back to list
                    </a>
