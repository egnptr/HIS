        ...
        bg-white rounded-lg shadow-md lg:shadow-lg">
            ...
            <form method="POST" action="{{ route('Radiologi.create') }}">
                ...
                <div class="bg-white sm:p-6">
                 ...
                 <div class="bg-white sm:p-6">
                    <label for="scanning_tool" class="block text-xs font-semibold text-gray-600 uppercase">Scanning Tool</label>
                    <select id="scanning_tool" name="scanning_tool" class="block w-full py-3 px-1 mt-2
                        text-gray-800 appearance-none
                        border-b-2 border-gray-100">
                ...
                <input id="type" type="text" name="type" value="Radiologi" hidden/>
