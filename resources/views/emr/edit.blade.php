...
<div class="flex flex-col h-screen">
    ...
    <div class="grid place-items-center mx-2">
        ...
        bg-white rounded-lg shadow-md lg:shadow-lg">
            ...
            <form method="POST" action="{{ route('emr.edit', $patient) }}" enctype="multipart/form-data">
                ...
                <div class="bg-white sm:p-6">
                    ...
                    <label for="diagnosis" class="block text-xs font-semibold text-gray-600 uppercase">File</label>

                    <input type="file" name="file" class="block w-full py-3 px-1 mt-2

                        text-gray-800 appearance-none

                        border-b-2 border-gray-100

                        focus:text-gray-500 focus:outline-none focus:border-gray-200" id="file">
